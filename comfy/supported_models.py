...
class SD20(supported_models_base.BASE):
    ...
    def model_type(self, state_dict, prefix=""):
        if self.unet_config["in_channels"] == 4: #SD2.0 inpainting models are not v prediction
            ...
            if out is not None and mint.std(out, unbiased=False) > 0.09: # not sure how well this will actually work. I guess we will find out.
...
models = [SD15_instructpix2pix, SD15, SD20, SD21UnclipL, SD21UnclipH, SDXL_instructpix2pix, SDXLRefiner, SDXL, SSD1B, Flux, QwenImage]