...
class UnetApplyFunction(Protocol):
    ...
    def __call__(self, x: mindspore.Tensor, t: mindspore.Tensor, **kwargs) -> mindspore.Tensor:
        pass
...
class UnetApplyConds(TypedDict):
    ...
    c_concat: Optional[mindspore.Tensor]
    c_crossattn: Optional[mindspore.Tensor]
    control: Optional[mindspore.Tensor]
...
UnetWrapperFunction = Callable[[UnetApplyFunction, UnetParams], mindspore.Tensor]
